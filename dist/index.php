...
<head>
  <meta charset="UTF-8">
  <title>CodePen - Login Page Anime.js</title>
  ...
  <link rel="shortcut icon" href="../img/re.png">
      ...
      <div class="col-sm-5 authfy-panel-left">
        <div class="brand-col">
          <div class="headline">
            ...
            <center><p>Para mas informacion siguenos en redes sociales</p></center>
            <!-- social login buttons start -->
            <div class="row social-buttons">
              <div class="col-xs-4 col-sm-4 col-md-12">
                <a href="#" class="btn btn-block btn-facebook">
                  <i class="fa fa-facebook"></i> <span class="hidden-xs hidden-sm">Siguenos en facebook</span>
                </a>
              </div>
              <div class="col-xs-4 col-sm-4 col-md-12">
                <a href="#" class="btn btn-block btn-twitter">
                  <i class="fa fa-twitter"></i> <span class="hidden-xs hidden-sm">Siguenos en twitter</span>
                </a>
              </div>
              <div class="col-xs-4 col-sm-4 col-md-12">
                <a href="#" class="btn btn-block btn-google">
                  <i class="fa fa-google-plus"></i> <span class="hidden-xs hidden-sm">Siguenos en instagram</span>
                </a>
              </div>
            </div><!-- ./social-buttons -->
          </div>
        ...
        <div class="authfy-login">
          ...
          <div class="authfy-panel panel-login text-center active">
            <div class="authfy-heading">
              <h3 class="auth-title">Inicie sesion</h3>
              <p>¿No tienes cuenta? <a class="lnk-toggler" data-panel=".panel-signup" href="#">Registrarse!</a></p>
            </div>
            <div class="row">
              <div class="col-xs-12 col-sm-12">
                <form name="loginForm" class="loginForm" action="#" method="POST">
                  <div class="form-group">
                    <input type="email" class="form-control email" name="usuario" placeholder="usuario">
                  </div>
                  <div class="form-group">
                    <div class="pwdMask">
                      <input type="password" class="form-control password" name="contraseña" placeholder="contraseña">
                  ...
                  <div class="row remember-row">
                    ...
                    <div class="col-xs-6 col-sm-6">
                      <p class="forgotPwd">
                        <a class="lnk-toggler" data-panel=".panel-forgot" href="#">¿Olvidaste la contraseña?</a>
                      </p>
                    </div>
                  </div> <!-- ./remember-row -->
                  <div class="form-group">
            ...
            <div class="row">
              <div class="col-xs-12 col-sm-12">
                ...
                <form name="signupForm" class="signupForm" action="#" method="POST">
                  <div class="form-group">
                    <input type="password" class="form-control" name="username" placeholder="Email address">
                  </div>
                  <div class="form-group">
            ...
            <div class="row">
              <div class="col-xs-12 col-sm-12">
                ...
                <form name="forgetForm" class="forgetForm" action="#" method="POST">
                  <div class="form-group">
                    <input type="USUARIO" class="form-control" name="username" placeholder="Email address">
                  </div>
                  <div class="form-group">
